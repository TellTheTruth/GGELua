...
local _tostring = function (a,b) return string.format("gge坐标:%s,%s",a.x,a.y) end
...
function point:取角度(p)
	return math.deg(self:取孤度(p))
end
function point:取地图位置(w,h)
